...
/**
 * @ngdoc object
 * @name lbServices.Venue
 * @header lbServices.Venue
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Venue` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Venue#create
         * @methodOf lbServices.Venue
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Venue#createMany
         * @methodOf lbServices.Venue
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Venues/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Venue#findById
         * @methodOf lbServices.Venue
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Venues/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Venue#find
         * @methodOf lbServices.Venue
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Venues/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Venue#updateAll
         * @methodOf lbServices.Venue
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Venues/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Venue#deleteById
         * @methodOf lbServices.Venue
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Venues/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Venue#prototype$updateAttributes
         * @methodOf lbServices.Venue
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Venue#createChangeStream
         * @methodOf lbServices.Venue
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Venues/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Venue#search
         * @methodOf lbServices.Venue
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Venue#updateOrCreate
         * @methodOf lbServices.Venue
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Venue#destroyById
         * @methodOf lbServices.Venue
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Venue#removeById
         * @methodOf lbServices.Venue
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Venue#modelName
    * @propertyOf lbServices.Venue
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Venue`.
    */
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Commerce#createChangeStream
         * @methodOf lbServices.Commerce
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Commerces/change-stream",
          method: "POST"
        },
      }
    );
